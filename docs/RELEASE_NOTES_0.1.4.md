# Vidwright v0.1.4 Draft Release Notes
...
- New `MoGraph` workspace in beta for building transparent motion graphics assets inside Vidwright
...
- Added built-in keymap presets for `Vidwright`, `Premiere-style`, `Resolve-style`, and `Final Cut-style` bindings
...
- Added a draft marketing/release site under `site/vidwright`
...
`Vidwright v0.1.4 - Editing polish and MoGraph workspace`
